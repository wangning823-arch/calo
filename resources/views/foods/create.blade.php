    ...
    <div class="md:ml-64 min-h-screen pb-10 md:pb-8 page-shell">
        ...
        <div class="app-header sticky top-14 md:top-0 z-20">
            <div class="px-4 py-3 flex items-center justify-between">
                <a href="{{ url()->previous() }}" class="text-gray-600 dark:text-gray-400">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                </a>
                <h1 class="text-lg font-semibold dark:text-white">创建自定义食物</h1>
                <div class="w-6"></div>
            </div>
        </div>
        ...
        <form action="{{ route('foods.store') }}" method="POST" class="px-4 mt-4 space-y-4"
            ...
            <!-- Preview -->
            <div x-show="calories" x-cloak class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-sm text-blue-700 dark:text-blue-300">
