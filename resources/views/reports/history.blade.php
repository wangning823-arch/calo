    ...
    <div class="md:ml-64 min-h-screen pb-10 md:pb-8 page-shell">
        ...
        <div class="px-4 mt-4">
            ...
            <div class="card p-8 text-center">
                <div class="text-[var(--calo-muted)] mb-2">暂无报告</div>
                <div class="text-sm text-[var(--calo-muted)]">记录饮食数据后即可生成报告</div>
            </div>
            @else
            <div class="card p-4 mb-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('reports.weekly', $report['period']) }}" class="block p-3 border border-[var(--calo-line)] rounded-lg hover:border-brand-300 dark:hover:border-brand-700 transition-colors">
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('reports.monthly', $report['period']) }}" class="block p-3 border border-[var(--calo-line)] rounded-lg hover:border-brand-300 dark:hover:border-brand-700 transition-colors">
                        <div class="text-sm font-medium">{{ $report['label'] }}</div>
                    </a>
                    @endforeach
                </div>
